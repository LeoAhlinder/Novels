...
export default function NovelWorkSpace() {
    ...
    useEffect(() => {
        async function checkIfUserValid() {
          try {      
            const res = await fetch(`http://152.42.128.44:3001/api/checkOwnerOfBook`, {
              method: "POST",
              headers: {
    ...
    useEffect(() => {
        if (validUser) {
          async function getBookInfo() {
            try {
              const res = await fetch(`http://152.42.128.44:3001/api/getBookInfo?id=${bookId}`, {
                method: "GET",
                headers: {
                  "Content-Type": "application/json",
                  "Accept": "application/json",
    ...
    const publishChapter = async () => {
      try {
        const res = await fetch(`http://152.42.128.44:3001/api/publishChapter`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            "Accept": "application/json",
    ...
    useEffect(() => {
        ...
        const fetchChapters = async () => {
          try{
            const res = await fetch(`http://152.42.128.44:3001/api/chapters/${bookTitle}`, {
              method: "GET",
              headers: {
                "Content-Type": "application/json",
                "Accept": "application/json"
